$(document).ready(function () {
    ...
    function createObstacle() {
        ...
        let obstacleHeight = 65;
        let obstacleWidth = 15;
        obstacle.css({ 'left': obstaclePosition, 'height': obstacleHeight + 'px' });
    ...
    function checkCollision(dino, obstacle) {
        ...
        let dinoBox = dino[0].getBoundingClientRect();
        let dinoLeft = dinoBox.left;
        let dinoRight = dinoBox.right;
        let dinoTop = dinoBox.top;
        let dinoBottom = dinoBox.bottom;

        let obstacleBox = obstacle[0].getBoundingClientRect();
        let obstacleLeft = obstacleBox.left;
        let obstacleRight = obstacleBox.right;
        let obstacleTop = obstacleBox.top;
        let obstacleBottom = obstacleBox.bottom;
